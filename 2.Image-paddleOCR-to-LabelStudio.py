...
images_folder_path  = "E:/Works/narendra_tasks/invoice-ocr/docai/pocr/template_data/invoice-templates-images"
images_folder_path  = "E:/Works/narendra_tasks/invoice-ocr/sample_bills/FW Electricity Bills of Various Vendors/process/small"
...
def extracted_tables_to_label_studio_json_file_with_paddleOCR(images_folder_path):
    ...
    for images in tqdm(os.listdir(images_folder_path)):
        if images.endswith('.png'):
            ...
            img = Image.open(f'{images_folder_path}/{images}')
    ...
    output_folder = "E:/Works/narendra_tasks/invoice-ocr/docai/pocr/template_data"
    output_folder = "E:/Works/narendra_tasks/invoice-ocr/sample_bills/FW Electricity Bills of Various Vendors/process/small"
    # saving label_stdui_task_list as json file to import in label_studio
    with open(f'{output_folder}/pocr-label-studio_input_file.json', 'w') as f:
